...
export async function generateMetadata({ params }: PageProps<"/provider/[slug]/manage/products/[catalogSlug]/images">): Promise<Metadata> {
  const { slug } = await params;
  return getProviderManageMetadata(decodeURIComponent(slug), "Product Images");
}

export default async function ProductImagesPage({ params }: PageProps<"/provider/[slug]/manage/products/[catalogSlug]/images">) {
