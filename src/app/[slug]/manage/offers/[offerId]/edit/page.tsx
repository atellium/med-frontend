...
export async function generateMetadata({ params }: PageProps<"/[slug]/manage/offers/[offerId]/edit">): Promise<Metadata> {
  const { slug } = await params;
  return getProviderManageMetadata(decodeURIComponent(slug), "Edit Offer");
}

export default async function EditOfferPage({ params }: PageProps<"/[slug]/manage/offers/[offerId]/edit">) {
