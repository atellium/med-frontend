...
export async function generateMetadata({ params }: PageProps<"/[slug]/manage/products/[catalogSlug]/edit">): Promise<Metadata> {
  const { slug } = await params;
  return getProviderManageMetadata(decodeURIComponent(slug), "Edit Product");
}

export default async function EditProductPage({ params }: PageProps<"/[slug]/manage/products/[catalogSlug]/edit">) {
